...
class MessageSDKTestCase(unittest.TestCase):
    ...
    def test_update_taskcard(self):
        self.message_sdk.update_taskcard(userids=['LiXiaoJun'], agentid=CLOCK_IN_ID, task_id='taskid123', clicked_key='key111')
...
class AppchatSDKTestCase(unittest.TestCase):
    ...
    def test_create_appchat(self):
        self.appchat_sdk.create_appchat(name='NAME', owner='LiXiaoJun', userlist=['LiXiaoJun', 'ChenFan'], chatid='CHATID')
...
class LinkedcorpMessageSDKTestCase(unittest.TestCase):
    ...
    def test_linkedcorpmessage(self):
        self.linkedcorpmessage_sdk.send_linkedcorpmessage(msgtype='text', agentid=CLOCK_IN_ID,
                touser=['LiXiaoJun'], text={"content": "你的快递已到，请携带工卡前往邮件中心领取。\n出发前可查看<a href=\"http://work.weixin.qq.com\">邮件中心视频实况</a>，聪明避开排队。"
                })
    ...
    def test_touser(self):
        with self.assertRaises(AssertionError):
            self.linkedcorpmessage_sdk.send_linkedcorpmessage(msgtype='text', agentid=CLOCK_IN_ID,
                    touser=1001*['LiXiaoJun'], text={"content" : "你的快递已到，请携带工卡前往邮件中心领取。\n出发前可查看<a href=\"http://work.weixin.qq.com\">邮件中心视频实况</a>，聪明避开排队。"
                    })
...
class MessagelistTestCase(unittest.TestCase):
    ...
    def test_textcard_description(self):
        messagecorrect = messagelist(msgtype='textcard', agentid=CLOCK_IN_ID, textcard={'title':'领奖通知',\
                                                'description':512*'<div class=\"gray\">2016年9月26日</div> <div class=\"normal\">恭喜你抽中iPhone 7一台，领奖码：xxxx</div><div class=\"highlight\">请于2016年10月10日前联系行政同事领取</div>',\
                                                'url':'URL', 'btntxt':'更多'})
        self.assertFalse(messagecorrect)
    ...
    def test_textcard_btntxt(self):
        messagecorrect = messagelist(msgtype='textcard', agenid=CLOCK_IN_ID, textcard={'title':'领奖通知',\
                                                'description':'<div class=\"gray\">2016年9月26日</div> <div class=\"normal\">恭喜你抽中iPhone 7一台，领奖码：xxxx</div><div class=\"highlight\">请于2016年10月10日前联系行政同事领取</div>',\
    ...
    def test_mpnews_articles(self):
        ...
        messagecorrect2 = messagelist(msgtype='mpnews', agentid=CLOCK_IN_ID, mpnews={'articles':[{},{},{},{},{},{},{},{},{},{}]})
        self.assertFalse(messagecorrect2)
    ...
    def test_markdown_content(self):
        messagecorrect = messagelist(msgtype='markdown', agentid=CLOCK_IN_ID, markdown={'content':1024*"您的会议室已经预定，稍后会同步到`邮箱`\
                >**事项详情**\
